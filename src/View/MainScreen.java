...
public class MainScreen extends JFrame {
	...
	public MainScreen() {
		...
		jp_mappings.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Mappings", TitledBorder.LEADING,
				TitledBorder.TOP, null, Color.BLACK));
		jp_mappings.setBounds(407, 11, 183, 170);
		...
		jp_amount_words.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Word(s)", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(0, 0, 0)));
		jp_amount_words.setBounds(407, 192, 183, 95);
		...
		jp_memoryTrace.setBorder(new TitledBorder(null, "MemoryTrace", TitledBorder.LEADING, TitledBorder.TOP, null, null));
